...
import buyboxAlertRoutes from "./routes/buyboxAlert.js";
import salesAlertRoutes from "./routes/salesAlert.js";
import priceAlertRoutes from "./routes/priceAlert.js";
import salesReportRoutes from "./routes/salesReport.js";
import saleReportRoutes from "./routes/saleReport.js";
...
const api: FastifyPluginAsync = async (instance: FastifyInstance) => {
  ...
  await instance.register(buyboxAlertRoutes);
  await instance.register(salesAlertRoutes);
  await instance.register(priceAlertRoutes);
  await instance.register(salesReportRoutes);
  await instance.register(saleReportRoutes);
